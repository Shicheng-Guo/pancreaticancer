...
* macs2 installation in hpc: `conda install -c bioconda macs2`, install [Miniconda3](https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh) with `sh Miniconda3-latest-Linux-x86_64.sh`
