...
* macs2 installation in hpc: `conda install -c bioconda macs2` and read carefully about [macs2 usage](https://github.com/taoliu/MACS/wiki/Advanced%3A-Call-peaks-using-MACS2-subcommands)
